    ...
    <main className="min-h-screen bg-[#faf8f1]">
      <div className="relative min-h-[280px] sm:min-h-[515px]">
        ...
        <header className="relative max-w-5xl mx-auto px-6 sm:px-10 pt-6 pb-3 flex items-center justify-between">
          ...
          <span className="flex items-center gap-2 rounded-full border border-[#cddaca] bg-[#fafbf1] px-4 py-2 text-[10px] font-bold uppercase tracking-[2px] text-[#244e3b]">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#3fa15e] opacity-75" />
              <span className="relative inline-flex h-2 w-2 rounded-full bg-[#2c7a44]" />
            </span>
            Live
          </span>
        </header>
